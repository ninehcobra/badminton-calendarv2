...
import { closeSidebar } from '@/presentation/store/slices/uiSlice';
...
export const Sidebar = () => {
    ...
    const navItems = [
        ...
        { name: 'Bản Đồ', href: '/map', icon: faMapMarkedAlt },
    ...
    return (
        <>
            ...
            <aside className={clsx(
                "fixed left-0 top-0 h-full w-64 bg-[#0a0a0a] border-r border-white/5 flex flex-col z-50 backdrop-blur-xl bg-opacity-95 transition-transform duration-300 ease-in-out md:translate-x-0",
